...
const MODULES = [
  { id:"documentos", icon:"◈", label:"Documentos", color:"#38bdf8", plan:"free",
    tools:[
      ...
      { id:"relatorio",  name:"Relatorio Executivo",  desc:"Relatorios claros e impactantes",         plan:"free" },
      { id:"email_corp", name:"E-mail Corporativo",   desc:"Comunicacoes formais e eficazes",         plan:"free" },
    ]},
  { id:"dados", icon:"◇", label:"Dados", color:"#a78bfa", plan:"free",
    tools:[
      { id:"analise",  name:"Analise de Dados",      desc:"Insights estrategicos dos seus dados",   plan:"free" },
      { id:"query",    name:"Gerar Query SQL",        desc:"Consultas SQL otimizadas",               plan:"starter" },
      { id:"previsao", name:"Previsao e Tendencias",  desc:"Antecipe cenarios do seu negocio",       plan:"starter" },
      { id:"kpis",     name:"Definir KPIs",           desc:"Metricas certas para seu negocio",       plan:"free" },
    ]},
  { id:"produtividade", icon:"◉", label:"Produtividade", color:"#34d399", plan:"free",
    tools:[
      { id:"ata",              name:"Ata de Reuniao",       desc:"Documente decisoes com clareza",     plan:"free" },
      { id:"resumo",           name:"Resumir Documento",    desc:"Sinteses executivas precisas",        plan:"free" },
  ...
  { id:"conteudo", icon:"◆", label:"Conteudo", color:"#f472b6", plan:"free",
    tools:[
      { id:"post_social", name:"Post para Redes Sociais", desc:"Conteudo que engaja e converte",      plan:"free" },
      { id:"blog",        name:"Artigo para Blog",        desc:"Conteudo que posiciona sua marca",    plan:"free" },
      { id:"email_mkt",   name:"E-mail Marketing",        desc:"Campanhas que geram resultados",      plan:"starter" },
      { id:"descricao",   name:"Descricao de Produto",    desc:"Textos que vendem mais",              plan:"free" },
    ]},
  { id:"financeiro", icon:"◎", label:"Financeiro", color:"#fbbf24", plan:"starter",
    tools:[
      { id:"orcamento",       name:"Gerar Orcamento",           desc:"Orcamentos profissionais prontos para envio",    plan:"starter" },
      { id:"fluxo_caixa",     name:"Modelo de Fluxo de Caixa",  desc:"Organize as financas do seu negocio",           plan:"starter" },
      { id:"precificacao",    name:"Calculadora de Precificacao",desc:"Precifique seus servicos corretamente",         plan:"starter" },
      { id:"nf_descritiva",   name:"Descricao para NF",         desc:"Texto profissional para notas fiscais",         plan:"free" },
    ]},
  { id:"juridico", icon:"⬡", label:"Juridico", color:"#fb923c", plan:"starter",
    tools:[
      { id:"lgpd",      name:"Politica de Privacidade (LGPD)", desc:"Politica adequada a legislacao brasileira", plan:"starter" },
      ...
      { id:"distrato",  name:"Distrato Comercial",             desc:"Encerre contratos com seguranca juridica",  plan:"business" },
    ]},
  { id:"rh", icon:"⬟", label:"RH & Pessoas", color:"#e879f9", plan:"starter",
    tools:[
      { id:"descricao_vaga",   name:"Descricao de Vaga",         desc:"Atraia os melhores talentos",               plan:"free" },
      { id:"avaliacao_desemp", name:"Avaliacao de Desempenho",   desc:"Formulario de avaliacao estruturado",       plan:"starter" },
      { id:"politica_interna", name:"Politica Interna",          desc:"Regulamentos claros para sua equipe",       plan:"starter" },
  ...
  { id:"vendas", icon:"⬢", label:"Vendas & CRM", color:"#2dd4bf", plan:"starter",
    tools:[
      ...
      { id:"proposta_parc", name:"Proposta de Parceria",     desc:"Parcerias estrategicas bem apresentadas",    plan:"starter" },
      { id:"followup",      name:"Follow-up de Cliente",     desc:"Mensagens que reativam negocios",           plan:"free" },
      { id:"analise_conc",  name:"Analise de Concorrente",   desc:"Mapeie seus concorrentes estrategicamente",  plan:"business" },
    ]},
  { id:"freelancer", icon:"◐", label:"Freelancer", color:"#60a5fa", plan:"free",
    tools:[
      ...
      { id:"proposta_free", name:"Proposta de Freelance",       desc:"Propostas que vencem a concorrencia",       plan:"free" },
      { id:"contrato_free", name:"Contrato Simples de Servico", desc:"Proteja-se juridicamente em cada projeto",  plan:"free" },
      { id:"bio_prof",      name:"Bio Profissional",            desc:"Apresentacao que gera credibilidade",       plan:"free" },
    ]},
  { id:"atendimento", icon:"◑", label:"Atendimento", color:"#34d399", plan:"starter",
    tools:[
      ...
      { id:"resp_reclamacao",  name:"Resposta para Reclamacao",     desc:"Resolva conflitos com profissionalismo",  plan:"free" },
      { id:"pesq_satisfacao",  name:"Pesquisa de Satisfacao NPS",   desc:"Meça a lealdade dos seus clientes",      plan:"starter" },
      { id:"faq_produto",      name:"FAQ do Produto",               desc:"Responda as duvidas antes que surjam",   plan:"free" },
    ]},
  { id:"premium", icon:"★", label:"Premium (Arquivos)", color:"#f59e0b", plan:"business",
    tools:[
      { id:"planilha_orcamento", name:"Planilha de Orcamento (Excel)", desc:"Orcamento profissional em .xlsx para download", plan:"business", output:"xlsx" },
      ...
      { id:"apresentacao_ppt",   name:"Apresentacao (PowerPoint)",      desc:"Slides profissionais em .pptx",                plan:"business", output:"pptx" },
      { id:"relatorio_pdf",      name:"Relatorio Executivo (PDF)",      desc:"Relatorio formatado em .pdf para download",    plan:"business", output:"pdf"  },
    ]},
];

const TOOL_PROMPTS = {
  contrato:"Voce e especialista em direito empresarial brasileiro. Gere um contrato profissional e completo com todas as clausulas necessarias. Use linguagem juridica adequada, inclua: partes envolvidas, objeto, valor, prazo, obrigacoes, rescisao e foro.",
  proposta:"Voce e especialista em vendas B2B. Crie uma proposta comercial persuasiva, estruturada e profissional. Inclua: apresentacao, problema, solucao, beneficios, investimento, proximo passo.",
  relatorio:"Voce e especialista em comunicacao executiva. Crie um relatorio executivo claro, estruturado e impactante com sumario, analise e recomendacoes.",
  email_corp:"Voce e especialista em comunicacao corporativa. Escreva um e-mail profissional, claro e persuasivo.",
  analise:"Voce e analista de dados senior. Analise os dados fornecidos, identifique padroes e gere insights estrategicos acionaveis.",
  query:"Voce e especialista em banco de dados. Gere uma query SQL otimizada, bem comentada e eficiente.",
  previsao:"Voce e especialista em business intelligence. Analise e projete tendencias e cenarios com base nos dados.",
  kpis:"Voce e especialista em gestao por indicadores. Sugira KPIs relevantes, como mensurar cada um e metas recomendadas.",
  ata:"Voce e especialista em comunicacao empresarial. Gere uma ata de reuniao profissional com pauta, decisoes e proximos passos.",
  resumo:"Voce e especialista em sintese de informacoes. Resuma o conteudo destacando pontos-chave, insights e acoes recomendadas.",
  onboarding:"Voce e especialista em gestao de pessoas. Crie um plano de onboarding completo e acolhedor para novo colaborador.",
  base_conhecimento:"Voce e especialista em gestao do conhecimento. Estruture as informacoes em categorias e artigos claros.",
  post_social:"Voce e especialista em marketing digital. Crie posts envolventes para as redes sociais com hashtags e CTA.",
  blog:"Voce e especialista em content marketing e SEO. Escreva artigo completo, otimizado, com introducao, desenvolvimento e conclusao.",
  ...
  termos_uso:"Voce e especialista em direito digital. Escreva termos de uso claros, completos e juridicamente adequados.",
  nda:"Voce e especialista em contratos. Gere um acordo de confidencialidade (NDA) profissional e robusto.",
  distrato:"Voce e especialista em contratos. Gere um distrato comercial formal encerrando o contrato original com seguranca.",
  descricao_vaga:"Voce e especialista em recrutamento. Escreva descricao de vaga atrativa com requisitos, beneficios e cultura.",
  avaliacao_desemp:"Voce e especialista em RH. Crie formulario de avaliacao de desempenho completo com criterios e escala.",
  politica_interna:"Voce e especialista em gestao de pessoas. Escreva politica interna clara e objetiva para a empresa.",
  roteiro_entrevista:"Voce e especialista em selecao. Crie roteiro de entrevista estruturado com perguntas comportamentais e tecnicas.",
  cold_call:"Voce e especialista em vendas. Crie script de cold call eficaz com abertura, qualificacao, pitch e fechamento.",
  proposta_parc:"Voce e especialista em parcerias comerciais. Crie proposta de parceria estrategica clara e convincente.",
  followup:"Voce e especialista em CRM. Escreva mensagem de follow-up eficaz que reativa o interesse do cliente.",
  analise_conc:"Voce e especialista em inteligencia competitiva. Faca analise estruturada do concorrente com pontos fortes, fracos e oportunidades.",
  briefing:"Voce e especialista em gestao de projetos. Crie briefing completo alinhando escopo, prazo, entregaveis e expectativas.",
  proposta_free:"Voce e especialista em freelance. Escreva proposta profissional que destaca valor, metodologia e diferenciais.",
  contrato_free:"Voce e especialista em contratos. Gere contrato simples de prestacao de servicos para freelancers com todas clausulas.",
  bio_prof:"Voce e especialista em personal branding. Escreva bio profissional impactante para LinkedIn, site ou apresentacoes.",
  roteiro_suporte:"Voce e especialista em customer success. Crie roteiro de atendimento padronizado para diferentes situacoes.",
  resp_reclamacao:"Voce e especialista em gestao de conflitos. Escreva resposta profissional e empatica para reclamacao de cliente.",
...
const PLANS = [
  { id:"free",      name:"Free",      price:"R$ 0",   period:"",     gens:"5 geracoes/mes",      gensLimit:5,     users:"1 usuario",          highlight:false, features:["Modulos basicos","5 geracoes por mes","Acesso a ferramentas Free","Suporte por e-mail"] },
  { id:"starter",   name:"Starter",   price:"R$ 97",  period:"/mes", gens:"150 geracoes/mes",     gensLimit:150,   users:"5 usuarios",          highlight:false, features:["Tudo do Free","150 geracoes/mes","5 usuarios","Modulos Financeiro e Juridico","Suporte prioritario","Historico 30 dias"] },
  { id:"business",  name:"Business",  price:"R$ 297", period:"/mes", gens:"500 geracoes/mes",     gensLimit:500,   users:"15 usuarios",         highlight:true,  features:["Tudo do Starter","500 geracoes/mes","15 usuarios","Download Excel, PPT e PDF","Analise de Concorrente","Distrato Comercial","Suporte dedicado"] },
  { id:"unlimited", name:"Unlimited", price:"R$ 897", period:"/mes", gens:"Geracoes ilimitadas",  gensLimit:99999, users:"Usuarios ilimitados",  highlight:false, features:["Tudo do Business","Geracoes ilimitadas","Usuarios ilimitados","IA personalizada","SLA dedicado","Integracao customizada","Treinamento da equipe"] },
];
...
const FAQS = [
  { q:"Preciso saber programar para usar o Arcane?", a:"Nao! O Arcane foi desenvolvido para qualquer profissional e autonomo. A interface e intuitiva e voce comeca a gerar resultados em minutos." },
  { q:"Os dados da minha empresa ficam seguros?", a:"Sim. Utilizamos criptografia e seus dados nunca sao usados para treinar modelos de IA. Seguimos todas as diretrizes da LGPD." },
  ...
  { q:"O plano Free tem limitacoes?", a:"O plano Free oferece 5 geracoes por mes para voce experimentar. Para uso profissional, recomendamos o Starter ou Business." },
  { q:"Como funcionam os downloads de Excel, PPT e PDF?", a:"No plano Business, a IA gera o conteudo estruturado e o sistema converte automaticamente para o formato escolhido. Voce faz o download direto pelo navegador." },
];

const HOW_STEPS = [
  { n:"01", title:"Crie sua conta",       desc:"Cadastre-se gratuitamente em menos de 1 minuto. Sem cartao necessario." },
  { n:"02", title:"Escolha a ferramenta", desc:"Selecione entre mais de 40 ferramentas em 10 modulos especializados." },
  { n:"03", title:"Insira seus dados",    desc:"Descreva o que voce precisa. Quanto mais detalhes, melhor o resultado." },
  { n:"04", title:"Receba o resultado",   desc:"A IA gera seu conteudo profissional em segundos. Copie ou faca download." },
];

const REVIEWS = [
  { name:"Carlos M.", role:"CEO - Agencia Digital", stars:5, text:"Economizo pelo menos 3 horas por dia gerando propostas e contratos. O Arcane virou ferramenta essencial da nossa agencia." },
  { name:"Fernanda L.", role:"Advogada Autonoma", stars:5, text:"Os contratos e NDA gerados sao de altissima qualidade. Adapto em minutos e mando direto pro cliente. Impressionante!" },
  { name:"Rodrigo S.", role:"Gerente Comercial", stars:5, text:"Os scripts de cold call e follow-up melhoraram muito nossa taxa de conversao. Vale cada centavo do Business." },
  { name:"Mariana T.", role:"Designer Freelancer", stars:5, text:"Como autonoma, uso os modelos de proposta e contrato toda semana. Profissional, rapido e em portugues. Amei!" },
  { name:"Pedro A.", role:"Analista de Dados", stars:5, text:"As queries SQL e analises de KPIs sao incrivelmente precisas. Poupei horas de trabalho so nessa semana." },
];
...
async function handlePremiumDownload(tool, content) {
  ...
  if (tool.output === "xlsx") {
    await downloadAsExcel(content, filename);
  } else if (tool.output === "pdf") {
    downloadAsText(content, filename, "txt", "text/plain");
  } else if (tool.output === "pptx") {
    downloadAsText(content, filename, "txt", "text/plain");
  }
}
    ...
    <div style={{ minHeight:"100vh", display:"flex", background:C.bg }}>
      ...
      <div style={{ width:"44%", background:C.surface, borderRight:`1px solid ${C.border}`, display:"flex", flexDirection:"column", justifyContent:"center", padding:"80px 64px" }}>
        ...
        <div style={{ marginTop:64 }}>
          ...
          <h2 style={{ fontSize:32, fontWeight:300, lineHeight:1.2, marginBottom:20, color:C.text }}>Conteudo profissional<br />em <span style={{ color:C.accent }}>segundos</span></h2>
          <p style={{ color:C.muted, fontSize:14, lineHeight:1.8, marginBottom:36 }}>Mais de 40 ferramentas de IA para empresas e autonomos brasileiros.</p>
          {["40+ ferramentas em 10 modulos","Resultados em menos de 30 segundos","100% em portugues, focado no Brasil"].map((f,i)=>(
        ...
        <div style={{ marginTop:48, paddingTop:28, borderTop:`1px solid ${C.border}` }}>
          ...
          <div style={{ color:C.muted, fontSize:13 }}>5 geracoes/mes · Todos os modulos basicos · Sem cartao</div>
        </div>
      </div>
...
function AppDashboard({ user, onLogout }) {
  ...
  const [activeTab,    setActiveTab]    = useState("dashboard"); // dashboard | history | upgrade
  ...
  const generate = async () => {
    ...
    try {
      ...
      const systemPrompt = TOOL_PROMPTS[activeTool.id] || "Voce e um assistente especializado. Gere o conteudo solicitado de forma profissional.";
  ...
  const copyResult = () => { navigator.clipboard.writeText(result); setToast("Copiado para a area de transferencia!"); };
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"10px 0" }}>
          ...
          {MODULES.map(mod=>(
            <div key={mod.id} className={`nav-item ${activeModule===mod.id?"active":""}`}
              ...
              {!canUseTool(user.plan, mod.plan) && <span style={{ fontSize:8, color:C.hint }}>🔒</span>}
            </div>
          ))}
        </div>
        ...
        <div className="topbar">
          <div>
            <div style={{ fontSize:14, fontWeight:500, color:C.text }}>
              {activeTab==="history"?"Historico":activeTab==="upgrade"?"Fazer Upgrade":activeModule?currentModule?.label:"Dashboard"}
            </div>
            <div style={{ fontSize:11, color:C.hint }}>
              {activeTab==="history"?"Suas geracoes recentes":activeTab==="upgrade"?"Desbloqueie mais ferramentas":activeModule?`${currentModule?.tools.length} ferramentas`:"Bem-vindo ao Arcane"}
            </div>
          </div>
        ...
        <div style={{ padding:28 }}>
          ...
          {activeTab==="dashboard"&&!activeModule&&(
            <>
              ...
              <div className="section-label">Modulos disponivels</div>
          ...
          {activeTab==="history"&&(
            <>
              <div style={{ marginBottom:24 }}>
                ...
                <h2 style={{ fontSize:22, fontWeight:400, color:C.text, marginBottom:4 }}>Suas geracoes</h2>
                <p style={{ color:C.muted, fontSize:13 }}>Ultimas {history.length} geracoes salvas localmente</p>
              </div>
              {history.length===0?(
                <div style={{ textAlign:"center", padding:"60px 0", color:C.hint }}>
                  <div style={{ fontSize:32, marginBottom:12 }}>◷</div>
                  <p>Nenhuma geracao ainda. Use uma ferramenta para comecar!</p>
                </div>
              ):(
                <div style={{ display:"grid", gridTemplateColumns:selectedHistory?"1fr 1fr":"1fr", gap:20 }}>
                  ...
                  {selectedHistory&&(
                    <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:C.radius, padding:20, height:"fit-content", position:"sticky", top:90 }}>
                      ...
                      <div style={{ fontSize:11, color:C.hint, marginBottom:10 }}>Input: {selectedHistory.input}</div>
          ...
          {activeTab==="upgrade"&&(
            <>
              <div style={{ marginBottom:32 }}>
                ...
                <p style={{ color:C.muted, fontSize:13 }}>Voce esta no plano <span style={{ color:C.accent, fontWeight:500 }}>{plan.name}</span>. Faca upgrade para desbloquear mais ferramentas.</p>
              </div>
              <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:14, marginBottom:32 }}>
                {PLANS.map((p,i)=>(
                  <div key={p.id} style={{ background:p.highlight?C.accentDim:C.card, border:`1.5px solid ${p.id===plan.id?C.accent:p.highlight?C.accentD:C.border}`, padding:22, borderRadius:C.radius, position:"relative", boxShadow:p.highlight?"0 0 32px rgba(56,189,248,0.12)":"none" }}>
                    ...
                    <div style={{ color:C.hint, fontSize:10, marginBottom:16, letterSpacing:0.5 }}>{p.gens} · {p.users}</div>
                    ...
                    <button onClick={()=>{ if(p.id==="free"){return;}else{window.open(MP_LINKS[p.id],"_blank");} }}
                      ...
                      {p.id===plan.id?"PLANO ATUAL":p.id==="free"?"GRATIS":"ASSINAR"}
                    </button>
          ...
          {activeTab==="module"&&activeModule&&!activeTool&&(
            <>
              <div style={{ display:"flex", alignItems:"center", gap:14, marginBottom:24 }}>
                <button onClick={()=>navTo("dashboard")} style={{ background:"transparent", color:C.muted, fontSize:11, padding:0, letterSpacing:1 }}>← DASHBOARD</button>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:14 }}>
                {currentModule?.tools.map(tool=>{
                  ...
                  return (
                    <div key={tool.id} className="tool-card" onClick={()=>{ if(locked){setToast(`Requer plano ${tool.plan.toUpperCase()}. Faca upgrade!`);navTo("upgrade");}else{setActiveTool(tool);} }}
                ...
                <div>
                  <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:10 }}>
                    ...
                    <div style={{ display:"flex", gap:10 }}>
                      ...
                      {result&&activeTool.output&&<button onClick={()=>handlePremiumDownload(activeTool,result)} style={{ background:"rgba(251,191,36,0.1)", color:"#fbbf24", fontSize:10, padding:"4px 10px", borderRadius:6, border:"1px solid rgba(251,191,36,0.2)" }}>⬇ BAIXAR {activeTool.output.toUpperCase()}</button>}
                    </div>
                  </div>
  ...
  return (
    <div style={{ background:C.bg, minHeight:"100vh", overflowX:"hidden" }}>
      ...
      <section style={{ minHeight:"100vh", display:"flex", alignItems:"center", position:"relative", overflow:"hidden", paddingTop:64 }}>
        ...
        <div style={{ maxWidth:1200, margin:"0 auto", padding:"0 48px", position:"relative", zIndex:1 }}>
          <div style={{ maxWidth:820 }}>
            <div className="tag anim-fi" style={{ animationDelay:"0.1s", opacity:0 }}>▶ Plataforma de IA para Empresas e Autonomos</div>
            <h1 className="anim-in" style={{ fontSize:"clamp(40px,6vw,80px)", fontWeight:300, lineHeight:0.95, textTransform:"uppercase", letterSpacing:"-0.02em", marginBottom:28, animationDelay:"0.2s", opacity:0, color:C.text }}>
              Gere conteudo<br />profissional com<br /><span style={{ color:C.accent, fontWeight:500 }}>inteligencia artificial</span>
            </h1>
            <p className="anim-in" style={{ color:C.muted, fontSize:17, lineHeight:1.8, marginBottom:44, maxWidth:540, animationDelay:"0.4s", opacity:0 }}>
              Mais de 40 ferramentas especializadas em documentos, dados, produtividade e conteudo. Para empresas e autonomos. Resultados profissionais em segundos.
            </p>
            ...
            <div className="anim-in" style={{ display:"flex", gap:48, marginTop:64, animationDelay:"0.8s", opacity:0 }}>
              {[{n:"40+",label:"Ferramentas de IA"},{n:"10",label:"Modulos especializados"},{n:"< 30s",label:"Tempo de geracao"}].map(s=>(
                <div key={s.n}>
      ...
      <section style={{ padding:"100px 48px", background:C.surface }}>
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:56 }}>
            <div className="tag reveal">Avaliacoes</div>
            <h2 className="reveal" style={{ fontSize:"clamp(28px,4vw,48px)", fontWeight:300, textTransform:"uppercase", letterSpacing:"-0.02em", color:C.text }}>O que nossos<br /><span style={{ color:C.accent }}>clientes dizem</span></h2>
          </div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:16 }}>
            {PLANS.map((plan,i)=>(
              <div key={plan.id} className="reveal" style={{ background:plan.highlight?C.accentDim:C.card, border:`1.5px solid ${plan.highlight?C.accent:C.border}`, padding:26, position:"relative", transitionDelay:`${i*0.1}s`, boxShadow:plan.highlight?"0 0 40px rgba(56,189,248,0.15)":"none", borderRadius:C.radiusLg }}>
                {plan.highlight&&<div style={{ position:"absolute", top:-12, left:"50%", transform:"translateX(-50%)", background:C.accent, color:"#000", fontSize:9, fontWeight:700, padding:"4px 16px", letterSpacing:2, whiteSpace:"nowrap", textTransform:"uppercase", borderRadius:20 }}>RECOMENDADO</div>}
                ...
                <div style={{ color:C.hint, fontSize:10, marginBottom:18, letterSpacing:0.5 }}>{plan.gens} · {plan.users}</div>
      ...
      <section style={{ padding:"100px 48px", textAlign:"center", position:"relative" }}>
        ...
        <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)", width:500, height:500, background:"radial-gradient(circle,rgba(56,189,248,0.1) 0%,transparent 70%)", pointerEvents:"none" }}/>
        <div style={{ maxWidth:600, margin:"0 auto", position:"relative", zIndex:1 }}>
          ...
          <p className="reveal" style={{ color:C.muted, fontSize:15, marginBottom:32 }}>Junte-se a centenas de empresas e autonomos que ja usam o Arcane para trabalhar de forma mais inteligente.</p>
